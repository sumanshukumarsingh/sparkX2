      ...
      <div className="flex items-center justify-between h-16 px-3 sm:px-4 md:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden sm:block">
            <h1 className="text-lg font-bold text-foreground">SparkX Control Center</h1>
            <p className="text-xs text-muted-foreground leading-none">Intelligent Robot Fleet Management</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          {/* Connection Status */}
          <div className="hidden sm:flex items-center gap-1 px-2 py-1 rounded-full text-xs font-semibold" style={{
