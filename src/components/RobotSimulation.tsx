...
export const RobotSimulation = ({ robotId }: RobotSimulationProps) => {
  ...
  useEffect(() => {
    if (controlMode === 'autonomous' && robotRef.current) {
      // Simulate autonomous behavior with random movements
      ...
      <Card className="bg-slate-900/50 border-slate-800 overflow-hidden">
        ...
        <div className="p-4 bg-slate-900/30">
          <p className="text-sm text-slate-400">
            Use WASD keys to move, SPACE to jump, or use the control buttons. Drag mouse to rotate camera.
          </p>
        </div>
      </Card>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <Button
                ...
                className="w-24 h-24 rounded-full bg-red-600 hover:bg-red-700 text-white shadow-lg border-4 border-red-800 flex-shrink-0"
                size="lg"
              >
