    ...
    const interval = setInterval(() => {
      setHealthData((prev) => ({
        ...
        overallHealth: Math.max(
          90,
          Math.min(98, prev.overallHealth + (Math.random() - 0.5) * 0.5)
        ),
        uptime: prev.uptime + 0.00056, // Add ~2 seconds in hours
        lastSync: new Date(),
      }));
    }, 2000);
    ...
    <Card className="p-4 card-gradient border-border">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Progress value={healthData.overallHealth} className="h-2" />
        </div>
